#!/usr/bin/env python3
"""Enable explicit VC4 master handoff and full atomic-modeset witness."""
...
def main() -> int:
    ...
    print(
        ...
        "legacy page flip, atomic primary-plane update, and full atomic "
        f"modeset witness in {args.source}"
    )
    return 0
